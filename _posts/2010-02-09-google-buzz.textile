...
In the past few weeks, we started to see a ton of subscriptions from Google to a lot of feeds for which we host the feed. I was confirmed by the google team that these subscriptions were used by all Google properties, including Buzz!
