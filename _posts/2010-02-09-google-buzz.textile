...
In the past few weeks, we started to see a ton of subscriptions from Google to a lot of feeds for which we host the feed. I'm pretty sure that soon all Google properties will use PubSubHubbub for the feeds!
