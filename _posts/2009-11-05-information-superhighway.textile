...
!{float:right; margin: 10px;}../../../../../../images/superhighway.png! Because we provide a service to developers and businesses it is quite difficult to "show off" to people without prior knowledge of the technology. "Julien":http://twitter.com/julien51 built our website with quite some interactivity, but it is still rather hard to understand because you're going to see the gory protocol in detail.
