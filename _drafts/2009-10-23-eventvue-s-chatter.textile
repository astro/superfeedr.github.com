...
When we started Superfeedr, "Josh":http://twitter.com/joshfraser helped us a lot by providing a good use-case. We said it in the past, but Superfeedr is yours, and you can thank him for his feedback. We're now thrilled that EventVue uses Superfeedr for its "chatter":http://www.eventvue.com/chatter_frame/index.php functionality.
...
EventVue uses "PHP":http://php.net/index.php and the "PubSubHubbub API":http://superfeedr.com/documentation#pubsubhubbub. They do not use any specific library.